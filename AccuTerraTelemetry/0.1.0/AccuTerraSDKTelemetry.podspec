Pod::Spec.new do |m|
  ...
  m.source = {
    :http => "https://distribution.accuterra.com/com/accuterra/accuterra-sdk-ios-telemetry/#{version}/accuterra-ios-telemetry-#{version}.zip",
    :flatten => true
  }
  ...
  m.dependency 'AccuTerraSDKCommon', '0.1.1'
