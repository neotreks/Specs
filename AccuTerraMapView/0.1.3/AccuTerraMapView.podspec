Pod::Spec.new do |m|
  ...
  m.name    = 'AccuTerraMapView'
  m.version = version

  m.summary           = 'AccuTerra MapView iOS.'
  m.description       = 'AccuTerra MapView iOS'
  ...
  m.source = {
    :http => "https://distribution.accuterra.com/com/accuterra/accuterra-ios-mapview/#{version}/accuterra-ios-mapview-#{version}.zip",
    :flatten => true
  }
  ...
  m.dependency 'AccuTerraSDKCommon', '0.1.3'

  m.requires_arc = true

  m.vendored_frameworks = 'AccuTerraMapView.xcframework'
  m.module_name = 'AccuTerraMapView'
