Pod::Spec.new do |m|
  ...
  m.name    = 'AccuTerraSDKCommon'
  m.version = version

  m.summary           = 'AccuTerra SDK Common iOS.'
  m.description       = 'AccuTerra SDK Common iOS'
  ...
  m.source = {
    :http => "https://distribution.accuterra.com/com/accuterra/accuterra-ios-sdk-common/#{version}/accuterra-ios-sdk-common-#{version}.zip",
    :flatten => true
  }
  ...
  m.vendored_frameworks = 'AccuTerraSDKCommon.xcframework'
  m.module_name = 'AccuTerraSDKCommon'
