Pod::Spec.new do |m|
  ...
  m.name    = 'AccuTerraSDKMapView'
  m.version = version

  m.summary           = 'AccuTerra SDK MapView iOS.'
  m.description       = 'AccuTerra SDK MapView iOS'
  ...
  m.source = {
    :http => "https://distribution.accuterra.com/com/accuterra/accuterra-ios-sdk-mapview/#{version}/accuterra-ios-sdk-mapview-#{version}.zip",
    :flatten => true
  }
  ...
  m.dependency 'AccuTerra-MapLibre-iOS-SDK', '~>5.12.0'
  m.dependency 'AccuTerraSDKCommon', '~>0.1.0'

  m.requires_arc = true

  m.vendored_frameworks = 'AccuTerraSDKMapView.xcframework'
  m.module_name = 'AccuTerraSDKMapView'
